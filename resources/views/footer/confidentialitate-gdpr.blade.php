...
@section('breadcrumbs')
<ul class="flex gap-xs"><li><a href="/">Acasa</a></li><li class="separator">/</li><li class="-ml-4"><a href="/despre-noi">Despre noi</a></li><li class="separator">/</li><li class="-ml-4 ellipsis">Politica de Confidentialitate </li></ul>
@endsection
        ...
        <div class="tab-content-container">
            <div id="Pagina1" class="tab-content active">
                <div class="tab-pane">
                    ...
                    <p><span class="alineat_span"></span>Accesarea/ vizitarea site-ului emex.ro se supune <a href="{{ url('/termeni-si-conditii') }}"><em class="link_color1">Termenilor si Conditiilor de Utilizare</em></a> si Politicii de Confidentialitate prezentate aici, implica acceptul dumneavoastra explicit cu privire la acestea, si reprezinta intreaga intelegere dintre parti.</p>
