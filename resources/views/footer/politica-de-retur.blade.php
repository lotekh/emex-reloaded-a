...
@section('breadcrumbs')
<ul class="flex gap-xs"><li class="font-xs"><a href="/">Acasa</a></li><li class="separator">/</li><li class="font-xs -ml-4"><a href="/despre-noi">Despre noi</a></li><li class="separator">/</li><li class="font-xs -ml-4 ellipsis">Politica de Retur</li></ul>
@endsection

@section('content')
<div class="hidden-xs">
    <div class="header_img_bg" id="retur_header" style="background-image: url('{{ asset('resources/images/Politica-de-retur.jpg') }}');">
        <div class="hibc">
            <div class="hibcsc">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="despre_noi_content_wrapper">
            <div class="despre_noi_section">
                <div class="politica_overwrite_div" id="ap">
                    ...
                    <ul>
                        <li>Pentru returnare, produsul (produsele) trebuie sa se afle in aceeasi stare in care au fost achizitionate.</li>
                        <li>Nu se accepta produse care prezinta modificari fizice, sau produse care au ambalajul original rupt sau desfacut.</li>
                        <li>De asemeni, <strong>produsele care prezinta modificari de continut nu vor fi acceptate pentru retur sau restituirea contravalorii.</strong></li>
                    </ul>
                    ...
                    <ul>
                        ...
                        <li>Prin transmiterea catre banca a solicitarii de anulare/ refacere a tranzactiei, in cazul in care plata s-a efectuat cu card bancar, daca produsele se returneaza in aceeasi zi in care s-a efectuat plata sau in toate cazurile in care produsele au fost achizitionate cu plata in rate, cu card de credit.</li>
                    </ul>
                    <h2 class="h2-style">4. REFUZUL RETURULUI</h2>
                    <ul>
