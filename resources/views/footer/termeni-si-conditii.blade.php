        ...
        <div class="tab-content-container">
            <div id="Pagina1" class="tab-content active">
                <div class="tab-pane" id="ap">
                    <p>
                        <span class="alineat_span"></span>Site-ul <a href="https://emex.ro" title="Emex by Romtehnochim"><span class="link_color1"><em>www.emex.ro</em></span></a> este proprietatea Romtehnochim s.r.l. Acest document stabileste termenii si conditiile in care puteti utiliza site-ul <em>www.emex.ro</em>, numit generic in continuare <strong>&#8220;Emex&#8221;</strong>.<br>
                        <span class="alineat_span"></span>Accesul si utilizarea site-ului <strong>&#8220;Emex&#8221;</strong> se face sub autoritatea acestor reguli, in termenii si conditiile de mai jos. Utilizarea site-ului, logarea si accesul la alte servicii, presupun implicit acceptarea acestor termeni si conditii, cu toate consecintele care decurg din acceptarea acestora.<br>
                    ...
                    <div class="descript_par">
                        ...
                        <p><span class="alineat_span"></span><strong>Site</strong> - reprezinta website-ul internet apartinand Romtehnochim s.r.l., care se afla la adresa <a href="https://emex.ro/" title="Emex by Romtehnochim"><span class="link_color1"><em>www.emex.ro</em></span></a>, prin intermediul caruia <em>utilizatorul</em> are acces la informatii privind produsele oferite de catre Romtehnochim s.r.l.<br>
                            ...
                            <span class="alineat_span"></span><strong>Vanzator</strong> - societatea comerciala Romtehnochim s.r.l., avand sediul in Jilava, str. Steaua Sudului, nr. 22, cod postal 077120, nr. de inregistrare la Registrul Comertului: J40/21214/1993 si Cod Identificare Fiscala (CIF) RO4643777.<br>
                        ...
                        <p><span class="alineat_span"></span><strong>Pretul, modalitatea de plata si termenul de plata</strong> sunt specificate in Comanda, sau in Oferta trimisa de catre Vanzator. In mod curent, sistemul agreat este plata <em>Facturii Proforma</em>, confirmarea acestei plati, urmata de predarea marfurilor catre curierul agreat, in urmatoarele 24 de ore.<br>
                            ...
                            <span class="alineat_span"></span><strong>Transport / Ambalare</strong> - Riscurile si responsabilitatile privind Bunurile sunt transferate de la Vanzator catre firma de curierat sau catre reprezentantul Cumparatorului, in momentul predarii coletului. Vanzatorul va asigura ambalarea corespunzatoare a Bunurilor si va asigura transmiterea documentelor insotitoare.<br>
                            <span class="alineat_span"></span>Vanzatorul nu are obligatia implicita de a asigura transportul bunurilor. Toate preturile comunicate de vanzator, reprezinta preturi ex-works, iar in cazul in care vanzatorul nu poate asigura transportul, din diverse cauze, acesta nu poate fi tras la raspundere pentru nelivrarea produselor.<br>
                        ...
                        <p><span class="alineat_span"></span>Imaginile sunt prezentate pe site cu titlu orientativ, si pot fi modificate oricand fara o comunicare prealabila. Produsele livrate pot diferi de imaginile prezentate in orice mod, datorita diferentelor inerente care pot sa apara intre poze si realitate, cat si datorita unor modificari de design ale site-ului, sau de prezentare a etichetelor, functie de modificarile legislatiei.<br>
                            ...
                            <span class="alineat_span"></span>Acest site este oferit in aceasta forma, fara alte garantii. Romtehnochim s.r.l. nu este si nu poate fi facut responsabil pentru inexactitati, indisponibilitati sau deficiente ale acestui site sau ale continutului sau.
                        </p>
                        <br>
                        <p class="text-center">
            ...
            <div id="Pagina2" class="tab-content">
                <div class="tab-pane" id="ab">
                    ...
                    <p><span class="alineat_span"></span>Orice litigiu aparut intre Cumparatori si Societate va fi rezolvat pe cale amiabila. In cazul in care nu s-a reusit stingerea conflictului pe cale amiabila, competenta revine instantelor de judecata romane din raza teritoriala a Romtehnochim s.r.l.</p>
                    <h2 class="h2-style">8. RETURNAREA PRODUSELOR</h2>
                    <p>
					<span class="alineat_span"></span>Datele prezentate in acest capitol sunt doar informative si trebuie tratate ca atare. Pentru informatii exacte, va rugam sa accesati <a href="https://emex.ro/politica-de-retur" title="Politica de reetur a Romtehnochim"><span class="link_color1"><em>Politica de Retur</em></span></a>, unde veti gasi precizari complete privind returnarea.<br>
					<span class="alineat_span"></span>Consumatorul, persoana fizica, poate solicita returnarea produselor in urmatoarele situatii:<br>
                        ...
                        <span class="alineat_span"></span>Daca dumneavoastra doriti sa returnati un colet trebuie sa o faceti prin intermediul unei firme de curierat, Taxa de curier <strong>va fi rambursata</strong>, doar in urmatoarele conditii: daca produsul primit este necorespunzator, sau nu este produsul comandat de dumneavoastra. In cazul in care produsul nu satisface asteptarile dumneavoastra, sau exista interpretari privind culorile solicitate (albastru de culoarea cerului, rosu de culoarea sangelui, etc.), taxa <strong>nu va fi rambursata</strong>.
                    </p>
                    <br>
                    <p class="text-center">
                        <img width="216" height="20" src="{{ asset('resources/images/general/End-of-page.png') }}" alt="Emex by Romtehnochim - Incheiere pagina">
            ...
            <div id="Pagina3" class="tab-content">
                <div class="tab-pane" id="am">
                    ...
                    <p><span class="alineat_span"></span>Informatiile utilizatorilor site-ului Emex sunt confidentiale si vor putea fi folosite numai pentru comunicari comerciale cu partenerii acestuia. Orice date specifice privitoare la situatia si starea produselor se pot obtine contactandu-ne online, la coordonatele cuprinse in prezentul site.<br>
                        ...
                        <span class="alineat_span"></span><em>&#8220;Emex&#8221;</em> foloseste &#8220;cookies&#8221; pentru a identifica utilizatorii. Acestea nu contin nici un fel de date personale ale utilizatorului si nu prezinta risc in cazul in care sunt interceptate de terte parti. Daca browser-ul este configurat sa nu le accepte, anumite pagini pot sa nu functioneze partial sau in totalitate. Mai multe detalii despre cookies veti gasi in pagina despre <a href="https://emex.ro/cookies" title="Cookies Emex"><span class="link_color1"><em>cookies</em></span></a>.
                    </p>
                    <br>
                    <p class="text-center">
                        <img width="216" height="20" src="{{ asset('resources/images/general/End-of-page.png') }}" alt="Emex by Romtehnochim - Incheiere pagina">
