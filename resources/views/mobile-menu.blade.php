    ...
    <div class="w-full mobile-header">
        <div class="main-container row justify-between align-center gap-md">
            ...
            <a href="{{ url('/') }}"" title="Pagina principala" class="mobile-logo">
                <img src="{{ asset('images/new_design/general/logo.png') }}" height="47.22" width="144" alt="Emex - un brand de incredere" title="Emex - brand al companiei Romtehnochim" class="logo">
            </a>
            ...
            <div class="row gap-lg w-full justify-end">
                <button id="open-search" title="open-search" role="button" class="cursor-pointer" onclick="toggleSearchLightbox()" aria-label="Cauta">
                    <img src="{{ asset('images/new_design/icons/search.svg') }}" width="16" height="16" alt="search-icon">
                </button>
                <a href="{{ url('/wishlist') }}" class="relative nav-icon" title="Favorite">
                    <div class="flex align-center">
                        <img width="20" height="20" src="{{ asset('images/new_design/icons/star.svg') }}" title="review-star" alt="review-star">
                    </div>
                    <div class="circle">
                        <span>
                ...
                <a href="{{ url('/produse-adaugate') }}" class="relative nav-icon" title="Cos">
                    <div class="flex align-center">
                        <img width="20" height="20" src="{{ asset('images/new_design/icons/cart.svg') }}" alt="cart-icon">
                    </div>
                    <div class="circle">
                        <span>
                            0 {{-- {{ $preorder_count }} --}}
