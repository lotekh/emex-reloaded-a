...
@section('breadcrumbs')
<ul class="flex gap-xs"><li><a href="/">Acasa</a></li><li class="separator">/</li><li class=" -ml-4"><a href="/produse">Produse</a></li><li class="separator">/</li><li class="-ml-4 ellipsis">Contact</li></ul>
@endsection
            ...
            <form id="cpf" method="POST" action="{{ route('contact.store') }}">
                ...
                <div class="form-group mt-32">
                    <div class="w-full col align-center">
                        <div class="col">
                            <div>
                                <label for="captchaResultBlade" id="captchaLabel-contactBlade">Spam check: </label>
