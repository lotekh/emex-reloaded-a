...
<div class="product-card">
    <div class="text-center">
        <a href="{{ $base_url . '/' . $product->slug }}" title="{{ $product->name }}">
            @php
                $featuredImageUrl = $product->featuredImage ? asset($product->featuredImage->path) : $base_url . '/images/default-placeholder.png';
            @endphp
        ...
        <div class="price row align-center product-price-pl">
            @if($initialVariation)
                <p>
                    ...
                    <span>/ {{ $initialVariation->quantity }}</span>
                </p>
            @else
