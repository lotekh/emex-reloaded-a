    ...
    <div id="plata_main_row">
        <div class="col-md-12 mb-60" id="Fond-plata">
            <div class="success">
                ...
                <p class="text-center paragraph-thank-you">IP dumneavoastra va fi logat in scopuri de securitate.<br>
                    <a href="{{ url('/confidentialitate-gdpr') }}">
                        <span class="link_color1"><em>Prelucrarea datelor</em></span>
                    </a> 
                    va fi efectuata doar in conformitate cu prevederile Regulamentului UE nr. 679/2016.
                </p>
            </div>
        </div>
    </div>
