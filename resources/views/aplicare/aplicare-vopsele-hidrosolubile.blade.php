...
@section('breadcrumbs')
<ul class="flex gap-xs"><li class="font-xs"><a href="/produse">Toate Produsele</a></li><li class="separator">/</li><li class="font-xs -ml-4"><a href="/vopsele-dispersii-hidrosolubile">Vopsele Hidrosolubile</a></li><li class="separator">/</li><li class="font-xs -ml-4 ellipsis">Aplicare Vopsele Hidrosolubile</li></ul>
@endsection
