...
@section('breadcrumbs')
<ul class="flex gap-xs"><li><a href="/produse">Toate Produsele</a></li><li class="separator">/</li><li class="-ml-4"><a href="/vopsele-dispersii-hidrosolubile">Vopsele Hidrosolubile</a></li><li class="separator">/</li><li class="-ml-4 ellipsis">Aplicare Vopsele Hidrosolubile</li></ul>
@endsection
...
@section('tab-buttons')
    ...
    <button type="button" name="current_tab" value="1" role="tab" class="btn user-valid valid"  aria-selected="false" tabindex="0" onclick="openTab(event, 'PregatireMetal')"><span>Pregatire Metal</span></button>
    <button type="button" name="current_tab" value="2" role="tab" class="btn user-valid valid" aria-selected="false" tabindex="0" onclick="openTab(event, 'PregatireLemn')"><span>Pregatire Lemn</span></button>
    <button type="button" name="current_tab" value="3" role="tab" class="btn user-valid valid"  aria-selected="false" tabindex="0" onclick="openTab(event, 'PregatireBeton')"><span>Pregatire Beton</span></button>
@endsection

@section('tab_contents')
    <div id="PregatireProdus" class="tab-content active">
        <h2 class="aplicare_tab_content_title aplicare_c_red">Lacuri si Vopsele Hidrosolubile “Emex”: Pregatire</h2>
                    <div class="aplicare_title_separator aplicare_separator_red"></div>
                    <div class="descript_par">
                        <p><span class="alineat_span"></span>In aceasta categorie se regasesc toate grundurile, vopselele si lacurile pe baza de polimeri acrilici, diluabile cu apa, ce au drept caracteristica principala cantitatea minora de emisii COV, in conditiile pastrarii unor performante remarcabile.</p>
                        <p><span class="alineat_span"></span>Instructiunile prezentate in aceste pagini au doar caracter orientativ. Pentru instructiuni detaliate cititi Fisa Tehnica a produsului sau solicitati instructiuni speciale de aplicare, pentru fiecare produs in parte, de la producator.</p>
                        ...
                        <ul>
                            ...
                            <li>Temperatura suportului: 5 - 40°C.°C</li>
                            ...
                            <li>Aplicarea sub 5°C nu este recomandata, intrucat pot aparea defecte de pelicula.</li>
    ...
    <div id="PregatireMetal" class="tab-content">
        <h2 class="aplicare_tab_content_title">Pregatirea pentru vopsire a suprafetelor din metal</h2>
                    ...
                    <div class="descript_par">
                        ...
                        <p><span class="alineat_span"></span>Se va avea in vedere intotdeauna aplicarea de <a href="/grund-solubil-apa" title="Grund anticoroziv pe baza de apa" class="link_color1"><em>Grund Hidrosolubil Anticoroziv “Emex AQ Eco”</em></a> sau sau a altui grund anticoroziv compatibil cu vopseaua aplicata ca strat final, atat pentru protejarea suprafetei metalice impotriva coroziunii, cat si pentru marirea aderentei stratului urmator.</p>
                        <p>
                            ...
                            <span class="attn-underline"><strong>NOTA</strong></span>: Aceste lacuri, vopsele sau grunduri solubile in apa <span class="subs-attn"><strong>NU</strong></span> sunt recomandate pentru suprafetele zincate, care se vor vopsi numai cu vopsele industriale, recomandate de producator.
                        </p>
    ...
    <div id="PregatireLemn" class="tab-content">
        <div class="col" id="tab_technical_chars2">
            ...
            <div class="descript_par">
                <p><span class="alineat_span"></span>Pregatirea pentru vopsire a suprafetei din lemn trebuie facuta cu mare atentie. Suprafata trebuie sa fie perfect uscata si curata inainte de aplicarea vopselei, fara urme de praf sau contaminanti.</p>
                <p><span class="alineat_span"></span>Alegerea unui sistem corect de vopsire va prelungi cu mult durata de viata a suprafetei din lemn vopsite, asigurand totodata si un aspect placut, corespunzator.</p>
                ...
                <ul>
                    ...
                    <li>Daca exista protectii anterioare in stare buna, se degreseaza cu solvent, se slefuieste suprafata inca umeda, cu hartie abraziva, se usuca si se desprafuieste.</li>
                    ...
                    <li>Suprafetele cu imperfectiuni (fisuri, denivelari, etc.) se niveleaza cu chit potrivit. Dupa uscare (10 - 20 min.) chitul se slefuieste, dupa care se desprafuieste suprafata.</li>
                    <li>Avand in vedere ca lemnul prezinta o suprafata in general poroasa, se va lua in considerare aplicarea unui grund de imbibare si/sau de egalizare.</li>
                    <li>Inainte de a aplica vopseaua, este indicat sa se aplice fie un grund pentru lemn, fie o amorsa facuta din vopseaua propriu-zisa, diluata cca. 30% cu apa.</li>
                    <li>Lacurile se aplica in general in 3 straturi, pentru obtinerea unui luciu, aspect si etalare deosebite. In general acestea necesita si slefuire intre straturi.</li>
                </ul>
                ...
                <p><span class="alineat_span"></span>Nu se vor aplica vopsele, grunduri sau lacuri solubile in apa pe lemn ud in profunzime, sau neuscat in limitele admise.</p>
            </div>
        </div>
    </div>

    <div id="PregatireBeton" class="tab-content">
        <div class="col" id="tab_technical_chars3">
            ...
            <div class="descript_par">
                ...
                <ul>
                    ...
                    <li>Oricare dintre operatiunile de inlaturare a vopselei vechi va fi urmata de slefuire.</li>
                    <li>Zonele atacate de mucegai se curata si se impregneaza cu solutii special destinate acestui scop, cum ar fi <a href="/solutie-anti-mucegai" title="Solutie de inlaturare a mucegaiului" class="link_color1">Sanitizantul Antimucegai “Emex Forte”</a></li>
                    ...
                    <li>Inainte de a aplica vopseaua, este indicat sa se aplice o amorsa facuta din vopseaua propriu-zisa, diluata cca. 30% cu apa..</li>
                </ul>
                <p><span class="alineat_span"></span>Incluziunile metalice vor fi acoperite in mod obligatoriu cu <a href="/grund-solubil-apa" title="Grund anticoroziv solubil in apa" class="link_color1"><em>Grund Anticoroziv Hidrosolubil “Emex AQ Eco”</em></a>, sau alt grund compatibil, la recomandarea producatorului, pentru a preveni aparitia fenomenelor de oxidare, ce se pot propaga prin stratul de vopsea.</p>
            </div>
        </div>
    </div>
...
@section('images')
    <img width="201" height="185" src="{{ asset('resources/images/aplicare/Vopsele-solubile-in-apa.jpg') }}" alt="Aspect zugraveli decorative lavabile" class="aplicare_image_sidebar justify-self-center">

    <img width="201" height="185" src="{{ asset('resources/images/aplicare/Vopsele-pe-baza-de-apa.jpg') }}" alt="Aspect zugraveli decorative lavabile" class="aplicare_image_sidebar justify-self-center">

    <img width="201" height="185" src="{{ asset('resources/images/aplicare/Vopsele-ecologice-pentru-metal.jpg') }}" alt="Aspect zugraveli decorative lavabile" class="aplicare_image_sidebar justify-self-center">
@endsection