...
@section('tab-buttons')
    ...
    <button type="button" name="current_tab" value="1" role="tab" class="btn user-valid valid" option="1" aria-selected="false" tabindex="0" onclick="openTab(event, 'LacuireLemn')"><span>Lacuire Lemn</span></button>
    <button type="button" name="current_tab" value="2" role="tab" class="btn user-valid valid" option="2" aria-selected="false" tabindex="0" onclick="openTab(event, 'Supralacuire')"><span>Supralacuire</span></button>
@endsection
...
@section('tab_contents')
    ...
    <div id="LacuireLemn" class="tab-content">
    ...
    <div id="Supralacuire" class="tab-content">
