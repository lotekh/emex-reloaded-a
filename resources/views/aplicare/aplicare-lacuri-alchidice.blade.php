...
@section('breadcrumbs')
<ul class="flex gap-xs"><li><a href="/produse">Toate Produsele</a></li><li class="separator">/</li><li class="-ml-4"><a href="/vopsele-decorative">Vopsele Decorative</a></li><li class="separator">/</li><li class="-ml-4 ellipsis">Aplicare Vopsele Decorative</li></ul>
@endsection
...
@section('tab-buttons')
    ...
    <button type="button" name="current_tab" value="1" role="tab" class="btn user-valid valid" aria-selected="false" tabindex="0" onclick="openTab(event, 'PregatireMetal')"><span>Lacuire Lemn</span></button>
    <button type="button" name="current_tab" value="2" role="tab" class="btn user-valid valid"aria-selected="false" tabindex="0" onclick="openTab(event, 'PregatireLemn')"><span>Supralacuire</span></button>
@endsection
