...
@section('breadcrumbs')
<ul class="flex gap-xs"><li class="font-xs"><a href="/produse">Toate Produsele</a></li><li class="separator">/</li><li class="font-xs -ml-4"><a href="/pardoseli-trafic">Pardoseli Turnate</a></li><li class="separator">/</li><li class="font-xs -ml-4 ellipsis">Aplicare Membrana Impermeabila</li></ul>
@endsection
...
@section('tab-buttons')
    ...
    <button type="button" name="current_tab" value="1" role="tab" class="btn user-valid valid" option="1" aria-selected="false" tabindex="0" onclick="openTab(event, 'PregatireSuprafata')"><span>Pregatire Suprafata</span></button>
...
@section('tab_contents')
    ...
    <div id="PregatireSuprafata" class="tab-content">
