...
class ContactController extends Controller
{
    public function store(Request $request)
    {
        ...
        $restrictedPhrases = ['All you need', 'per day', 'passive income', 'Здравствуйте', 'financial independence', 'invest', 'more revenue', 'lucky', 'quite natural', 'sex game', 'Cool website', '>>>>>>', '<<<<<<', 'call me'];
