    ...
    public function processCheckout(Request $request)
{
    ...
    if ($order) {
        ...
        // Pregătim datele pentru company_information
        ...
        if ($request->input('delivery_type') == 0 && $request->input('payment_method') == 'ramburs') {
            // valoarea de ramburs e 3% din valoarea comenzii fara tva, adica 3% din 81% din $order->total
        ...
        $order->total += $order->transport_price;
