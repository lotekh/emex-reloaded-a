  ...
  <div class="results">
    <div class="cosum text-center">
      ...
      <p>
        <?php
        if ( $tipsuprafata == "Metal" ) {
          echo "<strong>Consumul Total</strong> <span class='strat mark'>(1 strat)</span> de <span class='RaspunsEchoBold'>Grund Epoxidic Emulsionat Anticoroziv “Emex WD-AE”</span> pentru<br />";
          echo "Suprafata de tip <span class='RaspunsEchoBold'>$tipsuprafata</span> de <span class='RaspunsEchoBold'>$suprafata mp</span>,<br /> va fi de aprox. <span class='RaspunsEchoBold'>$consum_vopsea Kg</span> grund baza si <span class='RaspunsEchoBold'>$intaritor Kg</span> intaritor.<br />";
