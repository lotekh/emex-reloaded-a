...
if ( $granulatie == "2.2 - 3 mm" ) {
  $consum_tencuiala = $suprafata * 3.50;
...
<?php
if ( $granulatie == "1.2 - 1.8 mm" ) {
  echo "<strong>Consumul Mediu</strong> de <span class='RaspunsEchoBold'>Tencuiala Decorativa Structurata “Emex Quartz Dekor”</span> cu<br />";
