  ...
  <div class="results">
    <div class="cosum text-center">
      ...
      <p>
        <?php
        if ( $tipsuprafata == "Beton" ) {
          echo "<strong>Consumul Total</strong> <span class='strat mark'>(2 straturi)</span> de <span class='RaspunsEchoBold'>Vopsea Poliuretanica pentru Piscine “Emex Pool“</span> pentru<br />";
