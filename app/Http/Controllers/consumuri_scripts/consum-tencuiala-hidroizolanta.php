...
if ( $granulatie == "1.2 - 1.8 mm" ) {
  $consum_tencuiala = $suprafata * 1.7;
...
if ( $granulatie == "1.5 - 2.3 mm" ) {
  $consum_tencuiala = $suprafata * 2.5;
  $grund = $suprafata * 0.12;
  $apa = ( $consum_tencuiala + $grund ) * 0.08;
  $consum_tencuiala = number_format( $consum_tencuiala, 2, ",", "." );
  $grund = number_format( $grund, 2, ",", "." );
...
if ( $granulatie == "2.2 - 3 mm" ) {
  $consum_tencuiala = $suprafata * 3.5;
  $grund = $suprafata * 0.14;
  $apa = ( $consum_tencuiala + $grund ) * 0.10;
  $consum_tencuiala = number_format( $consum_tencuiala, 2, ",", "." );
  $grund = number_format( $grund, 2, ",", "." );
  $apa = number_format( $apa, 2, ",", "." );
}
...
<?php
if ( $granulatie == "1.2 - 1.8 mm" ) {
  echo "<strong>Consumul Total</strong> de <span class='RaspunsEchoBold'>Tencuiala Decorativa Impermeabila Siliconata “Emex Aqua Protect”</span> cu<br />";
