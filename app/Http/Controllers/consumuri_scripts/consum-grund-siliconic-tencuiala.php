                  ...
                  <div class="results">
                    <div class="cosum text-center">
                      ...
                      <p>
                        <?php
                        if ($tipsuprafata == "Tencuiala driscuita") {
                          echo "<b>Consumul Total Aproximativ</b> de <span class='RaspunsEchoBold'>Grund Siliconic cu Cuart pentru Tencuiala</span> pentru<br>";
