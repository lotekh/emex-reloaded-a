...
<?php
if ( $tipsuprafata == "Sapa" ) {
  echo "<strong>Consumul</strong> la 1 strat de <strong class='strat mark'>grosime = 1 mm</strong> de <span class='RaspunsEchoBold'>Membrana Hidroizolanta Poliuretanica “Emex” </span> pentru<br />";
  ...
  echo "Grund de Amorsare: <span class='RaspunsEchoBold'>$grund Kg</span>.<br />";
