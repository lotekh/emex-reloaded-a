...
<?php
if ( $tipsuprafata == "Tigla din Beton" ) {
  echo "<strong>Consumul Total</strong> <span class='strat mark'>(2 straturi)</span> de <span class='RaspunsEchoBold'>Vopsea de Tigla si Azbociment &ldquo;Emex&rdquo;</span> pentru<br />";
