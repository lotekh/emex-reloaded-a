...
<?php
if ( $tipsuprafata == "Lemn" ) {
  echo "<strong>Consumul Mediu</strong> <span class='strat mark'>la 1 strat</span> de <span class='RaspunsEchoBold'>Grund Alchidic pentru Lemn si Binale “Emex”</span> pentru<br />";
