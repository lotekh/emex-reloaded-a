...
<p class="p-space"><strong>Consumul Mediu Informativ:</strong></p>
...
<?php
if ( $tipsuprafata == "Metal" ) {
  echo "<strong>Consumul Total</strong> <span class='strat mark'>la 1 strat</span> de <span class='RaspunsEchoBold'>Vopseaua Epoxy-Ester “Emex Zinc Fusion Pro”</span> pentru<br />";
