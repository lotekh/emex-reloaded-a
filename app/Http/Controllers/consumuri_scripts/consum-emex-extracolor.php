 ...
 <div class="results">
  <div class="cosum text-center">
   ...
   <p>
    <?php
    if ( $tipsuprafata == "Lemn" ) {
     echo "<strong>Consumul Total</strong> <span class='strat mark'>la 2 straturi</span> de Email <span class='RaspunsEchoBold'>Vopsea Alchidica Decorativa “Emex Extracolor”</span> pentru<br />";
