...
<?php
if ( $tipsuprafata == "Metal" ) {
  echo "<strong>Consumul Total</strong> <span class='strat mark'>la 2 straturi</span> de Email <span class='RaspunsEchoBold'>Email Alchidic Uretanizat “Emex Code”</span> pentru<br />";
