...
<?php
if ( $tipsuprafata == "Piatra" ) {
  echo "<strong>Consumul Mediu</strong> <span class='strat mark'>la 1 strat</span> de <span class='RaspunsEchoBold'>Solutie Hidrofobizanta pentru Beton “Emex Concrete”</span> pentru<br />";
