...
if ( $tipsuprafata == "Zidarie" ) {
  $consum_amorsa_min = $suprafata * 0.10;
  $consum_apa_max = $suprafata * 0.10;
  $consum_amorsa_max = $suprafata * 0.15;
  $consum_apa_min = $suprafata * 0.05;
...
<?php
if ( $tipsuprafata == "Zidarie" ) {
  echo "<strong>Consumul Mediu</strong> <span class='strat mark'>la 1 strat</span> de <span class='RaspunsEchoBold'>Amorsa Silicatica pentru Pereti “Emex”</span> pentru<br/>";
