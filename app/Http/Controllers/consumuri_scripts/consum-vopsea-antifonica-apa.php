  ...
  <div class="results">
    <div class="cosum text-center">
      ...
      <p>
        <?php
        if ( $tipsuprafata == "Metal" ) {
          echo "<b>Consumul Mediu Total</b> <span class='strat'>(2 straturi)</span> de <span class='RaspunsEchoBold'>$tipvopsea</span> pentru<br />";
          ...
          echo "Apa: <span class='RaspunsEchoBold'>$diluant L</span>.<br />";
        }
        if ( $tipsuprafata == "Beton" ) {
          echo "<strong>Consumul Total</strong> <span class='strat'>(2 straturi)</span> de <span class='RaspunsEchoBold'>$tipvopsea</span> pentru<br />";
          echo "Suprafata de tip <span class='RaspunsEchoBold'>$tipsuprafata</span> de <span class='RaspunsEchoBold'>$suprafata mp</span>,<br />va fi de aprox. <span class='RaspunsEchoBold'>$consum_vopsea Kg</span> produs.<br />";
        }
        ?>
      </p>
