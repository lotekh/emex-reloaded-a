...
<?php
if ( $tipsuprafata == "Metal" ) {
  echo "<strong>Consumul Total</strong> <span class='strat mark'>la 1 strat</span> de Email <span class='RaspunsEchoBold'>Vopsea Metalizata cu Efect Hammerschlag “Emex”</span> pentru<br />";
