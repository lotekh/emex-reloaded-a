...
if ( $tipsuprafata == "Sapa" ) {
  ...
  $faina_cuart = $suprafata * 0.05;
  $consum_vopsea = number_format( $consum_vopsea, 2, ",", "." );
  $intaritor = number_format( $intaritor, 2, ",", "." );
  $grund = number_format( $grund, 2, ",", "." );
  $rezultat_faina_cuart = number_format( $faina_cuart, 2, ",", "." );
...
<?php
if ( $tipsuprafata == "Sapa" ) {
  echo "<strong>Consumul</strong> la 1 strat de <strong class='strat mark'>grosime = 1 mm</strong> de <span class='RaspunsEchoBold'>Pardoseala Epoxidica Autonivelanta “Emex”</span> pentru<br />";
  ...
  echo "cca. <span class='RaspunsEchoBold'>$rezultat_faina_cuart Kg</span> fulgi colorati.<br />";
