...
if ( $tipsuprafata == "Metal" ) {
  echo "<strong>Consumul Mediu</strong> <span class='strat mark'>la 1 strat</span> de <span class='RaspunsEchoBold'>Sistem Convertor de Rugina &ldquo;Emex Oxifer&rdquo;</span> pentru<br />";
  ...
  echo "Apa max.: <span class='RaspunsEchoBold'>$diluant L</span>.<br />";
}
?>
</p>
</div>
