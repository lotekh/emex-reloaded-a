...
if ( $tipsuprafata == "Sapa" ) {
  ...
  $intaritor = $consum_vopsea * 0.225;
  $cons_total = $consum_vopsea + $intaritor;
  $grund = $suprafata * 0.14;
  $diluant = ( $consum_vopsea + $intaritor ) * 0.03;
...
<?php
if ( $tipsuprafata == "Sapa" ) {
  echo "<strong>Consumul Total</strong> <span class='strat mark'>la 2 straturi</span> de <span class='RaspunsEchoBold'>Vopseaua Poliaspartica pentru Pardoseala “Emex P31-AS”</span> pentru<br />";
  ...
  echo "Grund de Amorsare (Poliuretanic sau Epoxidic): <span class='RaspunsEchoBold'>$grund Kg</span>.<br />";
