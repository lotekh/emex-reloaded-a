...
if ( $tipsuprafata == "Metal" ) {
  $consum_vopsea = $suprafata * 0.37;
  $intaritor = $consum_vopsea * 0.07;
...
<?php
if ( $tipsuprafata == "Metal" ) {
  echo "<strong>Consumul Total</strong> <span class='strat mark'>la 1 strat</span> de <span class='RaspunsEchoBold'>Grund Epoxi-Poliamidic cu Zinc “Emex PZ-302”</span> pentru<br />";
