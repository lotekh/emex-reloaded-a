...
<span class="small">la 3 straturi</span>
<p class="num-res"><?php echo $consum_vopsea; ?></p>
<p><strong>Kg produs</strong></p>
<p>
<?php
if ( $tipsuprafata == "Mobila" ) {
  echo "<strong>Consumul Total</strong> <span class='strat mark'>la 3 straturi</span> de <span class='RaspunsEchoBold'>Lac pentru Mobila Solubil in Apa “Emex”</span> pentru<br />";
