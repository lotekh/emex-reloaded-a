...
<?php
if ( $tipsuprafata == "Piatra" ) {
  echo "<strong>Consumul Total</strong> <span class='strat mark'>la 2 straturi</span> de <span class='RaspunsEchoBold'>Lac Impermeabilizant de Protectie “Emex Mineral Protect”</span> pentru<br />";
