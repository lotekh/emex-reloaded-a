...
<div class="paint-50 bor-bg">
  <div class="results">
    <div class="cosum text-center">
      ...
      <span class="small">(2 sau 3 straturi)</span>
      <p class="num-res"><?php echo $cons_total; ?></p>
      <p><strong>Kg produs</strong></p>
      <p>
        <?php
        if ( $tipsuprafata == "Mobila" ) {
          echo "<strong>Consumul Total</strong> <span class='strat mark'>la 3 straturi</span> de <span class='RaspunsEchoBold'>Vopsea Poliuretanica pentru Mobila “Emex”</span> pentru<br />";
          ...
          echo "Amorsa Epoxidica: <span class='RaspunsEchoBold'>$grund Kg</span>.<br />";
          echo "Diluant total: <span class='RaspunsEchoBold'>$diluant L</span>.<br />";
        }
        if ( $tipsuprafata == "Mobilier Gradina" ) {
          echo "<strong>Consumul Total</strong> <span class='strat mark'>la 2 straturi</span> de <span class='RaspunsEchoBold'>Vopsea Poliuretanica pentru Mobila “Emex”</span> pentru<br />";
          echo "Suprafata de tip <span class='RaspunsEchoBold'>$tipsuprafata</span> de <span class='RaspunsEchoBold'>$suprafata mp</span>,<br /> va fi de aprox. <span class='RaspunsEchoBold'>$consum_vopsea Kg</span> vopsea si <span class='RaspunsEchoBold'>$intaritor Kg</span> intaritor.<br />";
          echo "<span id='consumurile_indirecte'>Consumuri indirecte</span>:<br />";
          echo "Amorsa Epoxidica: <span class='RaspunsEchoBold'>$grund Kg</span>.<br />";
          echo "Diluant total: <span class='RaspunsEchoBold'>$diluant L</span>.<br />";
