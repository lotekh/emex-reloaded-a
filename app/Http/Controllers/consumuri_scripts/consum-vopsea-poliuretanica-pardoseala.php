  ...
  <div class="results">
    <div class="cosum text-center">
      ...
      <p>
        <?php
        if ( $tipsuprafata == "Sapa" ) {
          echo "<strong>Consumul Total</strong> <span class='strat mark'>la 2 straturi</span> de <span class='RaspunsEchoBold'>Vopsea Poliuretanica pentru Pardoseli “Emex”</span> pentru<br />";
