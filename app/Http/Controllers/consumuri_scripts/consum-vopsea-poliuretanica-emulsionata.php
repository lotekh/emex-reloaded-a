...
<?php
if ( $tipsuprafata == "Metal" ) {
  echo "<strong>Consumul Total</strong> <span class='strat mark'>la 2 straturi</span> de <span class='RaspunsEchoBold'>Vopsea Poliuretanica Baza Apa “Emex WPU-3SN”</span> pentru<br />";
  ...
  echo "Amorsa Poliuretanica Emulsionata: <span class='RaspunsEchoBold'>$grund Kg</span>.<br />";
