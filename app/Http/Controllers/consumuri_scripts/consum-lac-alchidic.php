...
<?php
if ( $tipsuprafata == "Lemn" ) {
  echo "<strong>Consumul Mediu</strong> <span class='strat mark'>la 2 straturi</span> de <span class='RaspunsEchoBold'>Lac Alchidic Lucios pentru Lemn “Emex“</span> pentru<br />";
