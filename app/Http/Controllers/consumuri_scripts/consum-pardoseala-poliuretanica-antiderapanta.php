...
<?php
if ( $tipsuprafata == "Sapa" ) {
  echo "<strong>Consumul</strong> la 1 strat de <strong class='strat mark'>grosime = 1 mm</strong> de <span class='RaspunsEchoBold'>Pardoseala Poliuretanica Antiderapanta “Emex”</span> pentru<br />";
  ...
  echo "Amorsa Epoxidica sau Poliuretanica: <span class='RaspunsEchoBold'>$grund Kg</span>.<br />";
  echo "Material Antiderapant: <span class='RaspunsEchoBold'>0,8 – 1,8 Kg/m²</span>.<br />";
