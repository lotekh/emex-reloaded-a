...
<span class="small">1 strat - 300&mu;m</span>
<p class="num-res"><?php echo $consum_vopsea; ?></p>
<p><strong>Kg produs</strong></p>
<p>
<?php
if ( $tipsuprafata == "Asfalt" ) {
  echo "<strong>Consumul Total Mediu</strong> <span class='strat mark'>la 1 strat de 300&mu;m</span> de <span class='RaspunsEchoBold'>Vopsea de Marcaj Rutier pe Baza de Apa “Emex WT-Urban”</span> pentru<br />";
