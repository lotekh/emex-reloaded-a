  ...
  <div class="results">
    <div class="cosum text-center">
      ...
      <p>
        <?php
        if ( $tipsuprafata == "Sapa" ) {
          echo "<strong>Consumul Total</strong> <span class='strat mark'>(2 straturi)</span> de <span class='RaspunsEchoBold'>Vopsea Epoxidica Emulsionata de Pardoseala “Emex Deck”</span> pentru<br />";
