...
if ( $tipsuprafata == "Lemn sau Fibra sticla" ) {
  ...
  <div class="results">
    <div class="cosum text-center">
      ...
      <p>
        <?php
        if ( $tipsuprafata == "Metal" ) {
          echo "<strong>Consumul Total</strong> <span class='strat mark'>(2 straturi)</span> <span class='RaspunsEchoBold'>Lac Poliuretanic de Protectie “Emex UV Shield”</span> pentru<br />";
        ...
        if ( $tipsuprafata == "Lemn sau Fibra sticla" ) {
          echo "<strong>Consumul Total</strong> <span class='strat mark'>(3 straturi)</span> <span class='RaspunsEchoBold'>Lac Poliuretanic de Protectie “Emex UV Shield”</span> pentru<br />";
          echo "Suprafata de tip <span class='RaspunsEchoBold'>$tipsuprafata</span> de <span class='RaspunsEchoBold'>$suprafata mp</span>,<br /> va fi de aprox. <span class='RaspunsEchoBold'>$consum_vopsea Kg</span> vopsea si <span class='RaspunsEchoBold'>$intaritor Kg</span> intaritor.<br />";
          echo "<span id='consumurile_indirecte'>Consumurile indirecte</span> vor fi:<br />";
          echo "Solvent cca.: <span class='RaspunsEchoBold'>$diluant L</span>.<br />";
        }
