...
<?php
if ( $tipsuprafata == "Lemn Slefuit" ) {
  echo "<strong>Consumul Total</strong> <span class='strat mark'>(1 strat)</span> de <span class='RaspunsEchoBold'>Amorsa Epoxidica pentru Lemn si Fibra de Sticla “Emex”</span> pentru<br />";
