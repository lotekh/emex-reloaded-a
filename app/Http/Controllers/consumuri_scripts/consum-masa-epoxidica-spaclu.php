...
if ( $tipsuprafata == "Sapa" ) {
  $consum_vopsea = $suprafata * 0.582;
  $intaritor = $consum_vopsea * 0.20;
...
<?php
if ( $tipsuprafata == "Sapa" ) {
  echo "<strong>Consumul</strong> la 1 strat de <strong class='strat mark'>grosime = 1 mm</strong> de <span class='RaspunsEchoBold'>Masa Epoxidica de Spaclu “Emex MSE 31”</span> pentru<br />";
