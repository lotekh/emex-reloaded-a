...
Route::get('/blog/tag={tag}', [BlogArticleController::class, 'searchByTag'])->name('blog.search.tag');
Route::get('/blog', [BlogArticleController::class, 'searchByArchive'])->name('blog.search.archive');
