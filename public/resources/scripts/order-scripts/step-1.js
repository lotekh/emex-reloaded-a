...
var organizationBillingContainer = document.getElementById('organization-billing-container');
var personBillingContainer = document.getElementById('person-billing-container');
...
var organizationLocalityId = document.getElementById('organization_locality_id');
...
var organizationContactPersonLastName = document.getElementById('contact_person_last_name');
var organizationContactPersonFirstName = document.getElementById('contact_person_first_name');
...
function validateAndProceedToStep2() {
    if(!this.classList.contains('btn-disabled')) {
        ...
        if(billingType.value == 0) {
            toValidate = personBillingContainer.getElementsByClassName('form-control');
        } 
        else if(billingType.value == 1) {
            toValidate = organizationBillingContainer.getElementsByClassName('form-control');
        } 
