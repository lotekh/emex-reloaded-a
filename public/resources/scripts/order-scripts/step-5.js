...
var summaryBillingCounty = document.querySelector('#summary_billing_county_name span');
var summaryBillingCity = document.querySelector('#summary_billing_city_name span');
var summaryBillingAddress = document.querySelector('#summary_billing_address span');
var summaryBillingCUIContainer = document.querySelector('#summary_billing_cui');
var summaryBillingBankContainer = document.querySelector('#summary_billing_bank');
var summaryBillingBankAccountContainer = document.querySelector('#summary_billing_bank_account');
...
var summaryBillingBankAccount = document.querySelector('#summary_billing_bank_account span');

var organizationBank = document.getElementById('organization_bank');
var organizationBankAccount = document.getElementById('organization_bank_account');
...
var summaryDeliveryPhone = document.querySelector('#summary_delivery_phone span');
var summaryDeliveryEmail = document.querySelector('#summary_delivery_email span');
var summaryDeliveryCounty = document.querySelector('#summary_delivery_county_name span');
var summaryDeliveryCity = document.querySelector('#summary_delivery_city_name span');
var summaryDeliveryAddress = document.querySelector('#summary_delivery_address span');
var summaryDeliveryNameContainer = document.getElementById('summary_delivery_name');
var summaryDeliveryPhoneContainer = document.getElementById('summary_delivery_phone');
var summaryDeliveryEmailContainer = document.getElementById('summary_delivery_email');
var summaryDeliveryCountyContainer = document.getElementById('summary_delivery_county_name');
var summaryDeliveryCityContainer = document.getElementById('summary_delivery_city_name');
var summaryDeliveryAddressContainer = document.getElementById('summary_delivery_address');
...
function populateSummary() {
    if(billingType.value == 0) {
        ...
        summaryBillingName.innerHTML = personFirstName.value + ' ' + personLastName.value;
        summaryBillingPhone.innerHTML = personPhone.value;
        summaryBillingEmail.innerHTML = personEmail.value;
        summaryBillingCounty.innerHTML = personCountyId.options[personCountyId.selectedIndex].text;
        ...
        summaryBillingCounty.innerHTML = organizationCountyId.options[organizationCountyId.selectedIndex].text;
    ...
    if(deliveryType.value == 1) {
        ...
        if(deliverySameAsBilling.checked) {
            if(billingType.value == 0) {
                summaryDeliveryName.innerHTML = personFirstName.value + ' ' + personLastName.value;
                summaryDeliveryPhone.innerHTML = personPhone.value;
                summaryDeliveryEmail.innerHTML = personEmail.value;
                summaryDeliveryCounty.innerHTML = personCountyId.options[personCountyId.selectedIndex].text;
                summaryDeliveryCity.innerHTML = personLocalityId.options[personLocalityId.selectedIndex].text;
                ...
                summaryDeliveryCounty.innerHTML = organizationCountyId.options[organizationCountyId.selectedIndex].text;
                summaryDeliveryCity.innerHTML = organizationLocalityId.options[organizationLocalityId.selectedIndex].text;
            ...
            summaryDeliveryName.innerHTML = deliveryFirstName.value + ' ' + deliveryLastName.value;
            summaryDeliveryPhone.innerHTML = deliveryPhone.value;
            summaryDeliveryEmail.innerHTML = deliveryEmail.value;
            summaryDeliveryCounty.innerHTML = deliveryCountyId.options[deliveryCountyId.selectedIndex].text;
            summaryDeliveryCity.innerHTML = deliveryLocalityId.options[deliveryLocalityId.selectedIndex].text;
            ...
            if (xmlhttp.readyState == XMLHttpRequest.DONE) {
                if (xmlhttp.status == 200) {
                    ...
                    if(paymentType.value == 'ramburs') {
                        ...
                        totalGeneral.textContent = Number(parseFloat(totalPrice) + 1.19 * parseFloat(price)).toFixed(2);
                    }
                }
...
function calculateRamburs(transportPrice = 0) {
    ...
    if(!isNaN(totalValue)){
        ...
        totalGeneral.textContent = Number(parseFloat(totalPrice) + 1.19 * transportPrice + parseFloat(rambursValue) + parseFloat(ramburs_TVA)).toFixed(2);
    }
}
